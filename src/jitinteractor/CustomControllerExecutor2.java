...
public class CustomControllerExecutor2 {
	 ...
	 */
	public CustomControllerExecutor2(Controller controller, String folder) throws IOException {
	 ...
	 * @throws IOException if the folder does not contain the controller files
	 */
	public CustomControllerExecutor2(Controller controller, String folder, boolean reordering) throws IOException {
	...
	public void initState(Map<String, String> initialInputs) throws IllegalStateException, IllegalArgumentException {
		...
		currentState = Env.randomSat(controller.initial().and(inputsBDD), Env.globalUnprimeVars());
...
//		if (currAndTrans.isZero()) {
		if (currAndTrans.andWith(Env.prime(inputsBDD)).isZero()) {
